...
// [Implements] ElectricMountainBike implements Gearable, Movable, and Electric
public class ElectricMountainBike extends Bicycle implements Gearable, Movable, Electric {
	...
	// [Is-A] ElectricMountainBike is an Object. equals(Object obj) overrides the equals(Object obj) method in the Object class
	@Override
	public boolean equals(Object obj) {
		...
		if (bike.getMake().equals(getMake()) && bike.getColor().equals(getColor())) return true;
		else return false;
	}
	...
	// [Is-A] ElectricMountainBike is an Object. toString() overrides the toString() method in the Object class
	@Override
	public String toString() {
		return String.format("ElectricMountainBike: make: %s wheels: %d color: %s", getMake(), getNumberOfWheels(), getColor().toString());
	}
}
